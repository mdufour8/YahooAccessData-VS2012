...
Namespace MathPlus
  ...
  Public Class FilterPearsonCorrelation
    ...
    Private MyInputValueLast As Tuple(Of Double, Double)
    ...
    Public Sub New(ByVal FilterRate As Integer)
      ...
      MyInputValueLast = New Tuple(Of Double, Double)(0, 0)
    End Sub
    ...
    Public Function Filter(X As Double, Y As Double) As Double Implements IFilterDuplex.Filter
      ...
      MyInputValueLast = New Tuple(Of Double, Double)(X, Y)
      'data capture 
    ...
    Public Function Last() As Tuple(Of Double, Double) Implements IFilterDuplex.Last
      Return MyInputValueLast
    End Function
  ...
  Public Interface IFilterDuplex
    ...
    Function Last() As Tuple(Of Double, Double)
