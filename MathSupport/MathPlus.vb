...
#Region "FilterOBV"
    ...
    Public Class FilterOBV
      ...
      Public Function Filter(ByVal Price As Double, ByVal Volume As Integer) As Double
...
#If DebugPrediction Then
        ...
        If IsHere = False Then
          IsHere = True
          Dim ThisResultPrediction As Double = Me.FilterPredictionNext(Price, Volume)
          Dim ThisResultActual = Me.Filter(Price, Volume)
          IsHere = False
          If ThisResultActual <> ThisResultPrediction Then
            Debugger.Break()
          End If
