...
Public Class MeasurePeakValueRange
	...
	Public Sub New(ByVal WindowSize As Integer, ByVal IsFilterPeakEnabled As Boolean, Optional FilterRate As Integer = FILTER_RATE_BAND)
		MyListOfWindowFrameHigh = New ListWindowFrame(WindowSize)
		MyListOfWindowFrameLow = New ListWindowFrame(WindowSize)
		MyListOfWindowFrameHighMinusOne = New ListWindowFrame(WindowSize - 1)
		MyListOfWindowFrameLowMinusOne = New ListWindowFrame(WindowSize - 1)
		...
		MyFilterHigh = New FilterLowPassExp(FilterRate:=FilterRate)
		MyFilterLow = New FilterLowPassExp(FilterRate:=FilterRate)
		MyListOfPeak = New List(Of IPeakValueRange)
		Me.FilterRate = MyFilterHigh.Rate
		Me.WindowSize = MyListOfWindowFrameHigh.WindowSize
	End Sub
