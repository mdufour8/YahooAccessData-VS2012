...
Namespace MathPlus.Filter
  Public Class FilterStochasticBrownian
    ...
    Private MyFilterVolatilityForBrownianStatisticLastPointTrail As FilterVolatilityYangZhang
    ...
    Private MyFilterForVolatilityStatistic As Filter.FilterStatistical
...
#Region "Private Functions"
    ...
    Private Sub FilterLocalPart1(ByVal ReportPrices As YahooAccessData.RecordPrices)
      ...
      For I = 0 To ReportPrices.NumberPoint - 1
        ...
        MyListOfValue.Add(Value)
        MyFilterLPForPrice.Filter(Value.Last)
        ThisFilterBasedVolatilityTotal = MyFilterVolatilityForBrownianStatistic.Filter(Value)
        ThisFilterBasedVolatilityFromPreviousCloseToOpen = MyFilterVolatilityForBrownianStatistic.ToList(Type:=FilterVolatilityYangZhang.enuVolatilityDailyPeriodType.PreviousCloseToOpen).Last
        ThisFilterBasedVolatilityFromOpenToClose = MyFilterVolatilityForBrownianStatistic.ToList(Type:=FilterVolatilityYangZhang.enuVolatilityDailyPeriodType.OpenToClose).Last
        ThisFilterBasedVolatilityFromLastPointTrailing = MyFilterVolatilityForBrownianStatisticLastPointTrail.Filter(Value)
        If ThisFilterBasedVolatilityTotal > 0 Then
    ...
    Private Sub FilterLocalPart2(ByVal ReportPrices As YahooAccessData.RecordPrices)
      ...
      For I = 0 To ReportPrices.NumberPoint - 1
        ...
        ThisFilterBasedVolatilityTotal = MyFilterVolatilityForBrownianStatistic.ToList.Item(I)
        ThisFilterBasedVolatilityFromLastPointTrailing = MyFilterVolatilityForBrownianStatisticLastPointTrail.ToList.Item(I)
...
#Region "IStochastic"
    ...
    Public Function PredictionOpenToClose(
      ...
      Dim ThisFilterBasedVolatilityFromOpenToClose = MyFilterVolatilityForBrownianStatistic.ToList(Type:=FilterVolatilityYangZhang.enuVolatilityDailyPeriodType.FullDay).Last
    ...
    Public Function FilterPredictionToClose(ByRef Index As Integer, ByVal NumberStepPerDay As Integer) As IList(Of IPriceVol)
      ...
      ThisFilterBasedVolatilityFromOpenToClose = MyFilterVolatilityForBrownianStatistic.ToList(Type:=FilterVolatilityYangZhang.enuVolatilityDailyPeriodType.OpenToClose)(Index)
    ...
    Private Function ToListData(ByVal Type As IStochastic.enuStochasticType) As IList(Of Double)
      Select Case Type
        ...
        Case IStochastic.enuStochasticType.RangeVolatilityFromPreviousCloseToOpen
          Return MyFilterVolatilityForBrownianStatistic.ToList(Type:=FilterVolatilityYangZhang.enuVolatilityDailyPeriodType.PreviousCloseToOpen)
        ...
        Case IStochastic.enuStochasticType.PriceVolatilityLastPointTrail
          Return MyFilterVolatilityForBrownianStatisticLastPointTrail.ToList
