...
Namespace MathPlus.Filter
	...
	Public Class FilterTransactionGainLog
		...
		Public Shared Function ToTransactionState(Data As Double, ThresholdDown As Double, ThresholdUp As Double) As FilterTransactionGain.enumControlBuySell
			Select Case Data
				Case < ThresholdDown
					Return FilterTransactionGain.enumControlBuySell.Sell
				Case > ThresholdUp
					Return FilterTransactionGain.enumControlBuySell.Buy
				Case Else
					Return FilterTransactionGain.enumControlBuySell.Hold
			End Select
		End Function
