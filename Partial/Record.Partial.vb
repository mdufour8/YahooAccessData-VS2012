...
#Region "IEquatable"
	Public Function EqualsDeep(other As Record, Optional ByVal IsIgnoreID As Boolean = False) As Boolean
		With other
			...
			If .Volume <> Me.Volume Then Return False
...
#Region "IStockPriceAdjusted"
	...
	Public ReadOnly Property Ratio As Double Implements IStockPriceAdjusted.Ratio
		Get
			Return _Ratio
		End Get
	End Property
	...
	Public ReadOnly Property PriceDelta As Double Implements IStockPriceAdjusted.PriceDelta
		Get
			Return _PriceDelta
		End Get
	End Property

	Public Function PriceDeltaPerCent() As Double Implements IStockPriceAdjusted.PriceDeltaPerCent
